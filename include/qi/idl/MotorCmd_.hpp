...
template <> constexpr const char* TopicTraits<::qi::msg::dds_::MotorCmd_>::getTypeName()
{
  return "qi::msg::dds_::MotorCmd_";
}

template <> constexpr bool TopicTraits<::qi::msg::dds_::MotorCmd_>::isKeyless()
{
  return true;
}

#ifdef DDSCXX_HAS_TYPE_DISCOVERY
template<> constexpr unsigned int TopicTraits<::qi::msg::dds_::MotorCmd_>::type_map_blob_sz() { return 470; }
template<> constexpr unsigned int TopicTraits<::qi::msg::dds_::MotorCmd_>::type_info_blob_sz() { return 100; }
template<> inline const uint8_t * TopicTraits<::qi::msg::dds_::MotorCmd_>::type_map_blob() {
 ...
 0x01,  0x00,  0x00,  0x00,  0x03,  0x07,  0x9c,  0x3b,  0x62,  0x94,  0x00,  0x00,  0xfe,  0x00,  0x00,  0x00, 
 0x01,  0x00,  0x00,  0x00,  0xf2,  0xd1,  0x9c,  0x89,  0x62,  0xef,  0x0b,  0x44,  0x49,  0x46,  0x72,  0xbd, 
 0xd1,  0x92,  0x4c,  0x00,  0xe6,  0x00,  0x00,  0x00,  0xf2,  0x51,  0x01,  0x00,  0x21,  0x00,  0x00,  0x00, 
 0x00,  0x00,  0x00,  0x00,  0x19,  0x00,  0x00,  0x00,  0x71,  0x69,  0x3a,  0x3a,  0x6d,  0x73,  0x67,  0x3a, 
 ...
 0x22,  0x00,  0x00,  0x00,  0x01,  0x00,  0x00,  0x00,  0xf2,  0xd1,  0x9c,  0x89,  0x62,  0xef,  0x0b,  0x44, 
 0x49,  0x46,  0x72,  0xbd,  0xd1,  0x92,  0x4c,  0xf1,  0xc8,  0xe5,  0x83,  0x5b,  0x0f,  0x0c,  0x17,  0x65, 
 0xbc,  0x23,  0x1d,  0xfa,  0x02,  0xff, };
  return blob;
}
template<> inline const uint8_t * TopicTraits<::qi::msg::dds_::MotorCmd_>::type_info_blob() {
  static const uint8_t blob[] = {
 ...
 0x14,  0x00,  0x00,  0x00,  0xf2,  0xd1,  0x9c,  0x89,  0x62,  0xef,  0x0b,  0x44,  0x49,  0x46,  0x72,  0xbd, 
 0xd1,  0x92,  0x4c,  0x00,  0xea,  0x00,  0x00,  0x00,  0x00,  0x00,  0x00,  0x00,  0x04,  0x00,  0x00,  0x00, 
 0x00,  0x00,  0x00,  0x00, };
  return blob;
}
...
template <>
struct topic_type_name<::qi::msg::dds_::MotorCmd_>
{
    static std::string value()
    {
      return org::eclipse::cyclonedds::topic::TopicTraits<::qi::msg::dds_::MotorCmd_>::getTypeName();
    }
};
...
REGISTER_TOPIC_TYPE(::qi::msg::dds_::MotorCmd_)
...
template<>
propvec &get_type_props<::qi::msg::dds_::MotorCmd_>();

template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool write(T& streamer, const ::qi::msg::dds_::MotorCmd_& instance, entity_properties_t *props) {
  (void)instance;
...
bool write(S& str, const ::qi::msg::dds_::MotorCmd_& instance, bool as_key) {
  auto &props = get_type_props<::qi::msg::dds_::MotorCmd_>();
  str.set_mode(cdr_stream::stream_mode::write, as_key);
  return write(str, instance, props.data()); 
}

template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool read(T& streamer, ::qi::msg::dds_::MotorCmd_& instance, entity_properties_t *props) {
  (void)instance;
  if (!streamer.start_struct(*props))
    return false;
  auto prop = streamer.first_entity(props);
...
template<typename S, std::enable_if_t<std::is_base_of<cdr_stream, S>::value, bool> = true >
bool read(S& str, ::qi::msg::dds_::MotorCmd_& instance, bool as_key) {
  auto &props = get_type_props<::qi::msg::dds_::MotorCmd_>();
...
template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool move(T& streamer, const ::qi::msg::dds_::MotorCmd_& instance, entity_properties_t *props) {
  (void)instance;
  if (!streamer.start_struct(*props))
    return false;
  auto prop = streamer.first_entity(props);
...
template<typename S, std::enable_if_t<std::is_base_of<cdr_stream, S>::value, bool> = true >
bool move(S& str, const ::qi::msg::dds_::MotorCmd_& instance, bool as_key) {
  auto &props = get_type_props<::qi::msg::dds_::MotorCmd_>();
...
template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool max(T& streamer, const ::qi::msg::dds_::MotorCmd_& instance, entity_properties_t *props) {
  (void)instance;
  if (!streamer.start_struct(*props))
    return false;
  auto prop = streamer.first_entity(props);
...
template<typename S, std::enable_if_t<std::is_base_of<cdr_stream, S>::value, bool> = true >
bool max(S& str, const ::qi::msg::dds_::MotorCmd_& instance, bool as_key) {
  auto &props = get_type_props<::qi::msg::dds_::MotorCmd_>();

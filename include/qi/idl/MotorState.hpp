/****************************************************************
  ...
  File name: MotorState.idl
  Source: MotorState.hpp
  Cyclone DDS: v0.10.5

*****************************************************************/
#ifndef DDSCXX_MOTORSTATE_HPP
#define DDSCXX_MOTORSTATE_HPP
...
template <> constexpr const char* TopicTraits<::qi::MotorState>::getTypeName()
{
  return "qi::MotorState";
}

template <> constexpr bool TopicTraits<::qi::MotorState>::isKeyless()
{
  return true;
}

#ifdef DDSCXX_HAS_TYPE_DISCOVERY
template<> constexpr unsigned int TopicTraits<::qi::MotorState>::type_map_blob_sz() { return 638; }
template<> constexpr unsigned int TopicTraits<::qi::MotorState>::type_info_blob_sz() { return 100; }
template<> inline const uint8_t * TopicTraits<::qi::MotorState>::type_map_blob() {
 ...
 0x01,  0x00,  0x00,  0x00,  0x02,  0x07,  0x9c,  0x3b,  0x62,  0x94,  0x00,  0x00,  0x66,  0x01,  0x00,  0x00, 
 0x01,  0x00,  0x00,  0x00,  0xf2,  0x6b,  0xc0,  0x18,  0x1d,  0x92,  0x0a,  0xe1,  0xb1,  0x9d,  0xbd,  0x5b, 
 0xf9,  0x88,  0x7d,  0x00,  0x4e,  0x01,  0x00,  0x00,  0xf2,  0x51,  0x01,  0x00,  0x17,  0x00,  0x00,  0x00, 
 ...
 0xf2,  0x6b,  0xc0,  0x18,  0x1d,  0x92,  0x0a,  0xe1,  0xb1,  0x9d,  0xbd,  0x5b,  0xf9,  0x88,  0x7d,  0xf1, 
 0x42,  0xa2,  0x28,  0x8b,  0x79,  0x8a,  0xf8,  0xdb,  0x05,  0xe1,  0x27,  0x36,  0xb1,  0xbe, };
  return blob;
}
template<> inline const uint8_t * TopicTraits<::qi::MotorState>::type_info_blob() {
  static const uint8_t blob[] = {
 ...
 0x14,  0x00,  0x00,  0x00,  0xf2,  0x6b,  0xc0,  0x18,  0x1d,  0x92,  0x0a,  0xe1,  0xb1,  0x9d,  0xbd,  0x5b, 
 0xf9,  0x88,  0x7d,  0x00,  0x52,  0x01,  0x00,  0x00,  0x00,  0x00,  0x00,  0x00,  0x04,  0x00,  0x00,  0x00, 
 0x00,  0x00,  0x00,  0x00, };
  return blob;
}
...
template <>
struct topic_type_name<::qi::MotorState>
{
    static std::string value()
    {
      return org::eclipse::cyclonedds::topic::TopicTraits<::qi::MotorState>::getTypeName();
    }
};
...
REGISTER_TOPIC_TYPE(::qi::MotorState)
...
template<>
propvec &get_type_props<::qi::MotorState>();

template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool write(T& streamer, const ::qi::MotorState& instance, entity_properties_t *props) {
  (void)instance;
...
bool write(S& str, const ::qi::MotorState& instance, bool as_key) {
  auto &props = get_type_props<::qi::MotorState>();
  str.set_mode(cdr_stream::stream_mode::write, as_key);
  return write(str, instance, props.data()); 
}

template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool read(T& streamer, ::qi::MotorState& instance, entity_properties_t *props) {
  (void)instance;
  if (!streamer.start_struct(*props))
    return false;
  auto prop = streamer.first_entity(props);
...
template<typename S, std::enable_if_t<std::is_base_of<cdr_stream, S>::value, bool> = true >
bool read(S& str, ::qi::MotorState& instance, bool as_key) {
  auto &props = get_type_props<::qi::MotorState>();
...
template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool move(T& streamer, const ::qi::MotorState& instance, entity_properties_t *props) {
  (void)instance;
  if (!streamer.start_struct(*props))
    return false;
  auto prop = streamer.first_entity(props);
...
template<typename S, std::enable_if_t<std::is_base_of<cdr_stream, S>::value, bool> = true >
bool move(S& str, const ::qi::MotorState& instance, bool as_key) {
  auto &props = get_type_props<::qi::MotorState>();
...
template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool max(T& streamer, const ::qi::MotorState& instance, entity_properties_t *props) {
  (void)instance;
  if (!streamer.start_struct(*props))
    return false;
  auto prop = streamer.first_entity(props);
...
template<typename S, std::enable_if_t<std::is_base_of<cdr_stream, S>::value, bool> = true >
bool max(S& str, const ::qi::MotorState& instance, bool as_key) {
  auto &props = get_type_props<::qi::MotorState>();

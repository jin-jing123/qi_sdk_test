/****************************************************************
  ...
  File name: IMUState.idl
  Source: IMUState.hpp
  Cyclone DDS: v0.10.5

*****************************************************************/
#ifndef DDSCXX_IMUSTATE_HPP
#define DDSCXX_IMUSTATE_HPP
...
template <> constexpr const char* TopicTraits<::qi::IMUState>::getTypeName()
{
  return "qi::IMUState";
}

template <> constexpr bool TopicTraits<::qi::IMUState>::isKeyless()
{
  return true;
}

#ifdef DDSCXX_HAS_TYPE_DISCOVERY
template<> constexpr unsigned int TopicTraits<::qi::IMUState>::type_map_blob_sz() { return 478; }
template<> constexpr unsigned int TopicTraits<::qi::IMUState>::type_info_blob_sz() { return 100; }
template<> inline const uint8_t * TopicTraits<::qi::IMUState>::type_map_blob() {
 ...
 0x02,  0x01,  0x00,  0x00,  0x01,  0x00,  0x00,  0x00,  0xf2,  0x31,  0x1b,  0xde,  0x6c,  0x99,  0x7b,  0x30, 
 0xb5,  0x5d,  0x04,  0x26,  0x35,  0x4e,  0x2b,  0x00,  0xea,  0x00,  0x00,  0x00,  0xf2,  0x51,  0x01,  0x00, 
 ...
 0xf2,  0x31,  0x1b,  0xde,  0x6c,  0x99,  0x7b,  0x30,  0xb5,  0x5d,  0x04,  0x26,  0x35,  0x4e,  0x2b,  0xf1, 
 0x4b,  0x1b,  0xf4,  0xaf,  0x32,  0xe5,  0xbc,  0x67,  0x10,  0xef,  0xc8,  0x29,  0x31,  0x15, };
  return blob;
}
template<> inline const uint8_t * TopicTraits<::qi::IMUState>::type_info_blob() {
  static const uint8_t blob[] = {
 ...
 0x14,  0x00,  0x00,  0x00,  0xf2,  0x31,  0x1b,  0xde,  0x6c,  0x99,  0x7b,  0x30,  0xb5,  0x5d,  0x04,  0x26, 
 0x35,  0x4e,  0x2b,  0x00,  0xee,  0x00,  0x00,  0x00,  0x00,  0x00,  0x00,  0x00,  0x04,  0x00,  0x00,  0x00, 
 0x00,  0x00,  0x00,  0x00, };
  return blob;
}
...
template <>
struct topic_type_name<::qi::IMUState>
{
    static std::string value()
    {
      return org::eclipse::cyclonedds::topic::TopicTraits<::qi::IMUState>::getTypeName();
    }
};
...
REGISTER_TOPIC_TYPE(::qi::IMUState)
...
template<>
propvec &get_type_props<::qi::IMUState>();

template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool write(T& streamer, const ::qi::IMUState& instance, entity_properties_t *props) {
  (void)instance;
...
bool write(S& str, const ::qi::IMUState& instance, bool as_key) {
  auto &props = get_type_props<::qi::IMUState>();
  str.set_mode(cdr_stream::stream_mode::write, as_key);
  return write(str, instance, props.data()); 
}

template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool read(T& streamer, ::qi::IMUState& instance, entity_properties_t *props) {
  (void)instance;
  if (!streamer.start_struct(*props))
    return false;
  auto prop = streamer.first_entity(props);
...
template<typename S, std::enable_if_t<std::is_base_of<cdr_stream, S>::value, bool> = true >
bool read(S& str, ::qi::IMUState& instance, bool as_key) {
  auto &props = get_type_props<::qi::IMUState>();
...
template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool move(T& streamer, const ::qi::IMUState& instance, entity_properties_t *props) {
  (void)instance;
  if (!streamer.start_struct(*props))
    return false;
  auto prop = streamer.first_entity(props);
...
template<typename S, std::enable_if_t<std::is_base_of<cdr_stream, S>::value, bool> = true >
bool move(S& str, const ::qi::IMUState& instance, bool as_key) {
  auto &props = get_type_props<::qi::IMUState>();
...
template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool max(T& streamer, const ::qi::IMUState& instance, entity_properties_t *props) {
  (void)instance;
  if (!streamer.start_struct(*props))
    return false;
  auto prop = streamer.first_entity(props);
...
template<typename S, std::enable_if_t<std::is_base_of<cdr_stream, S>::value, bool> = true >
bool max(S& str, const ::qi::IMUState& instance, bool as_key) {
  auto &props = get_type_props<::qi::IMUState>();

...
template <> constexpr const char* TopicTraits<::qi::MotorCmd>::getTypeName()
{
  return "qi::MotorCmd";
}

template <> constexpr bool TopicTraits<::qi::MotorCmd>::isKeyless()
{
  return true;
}

#ifdef DDSCXX_HAS_TYPE_DISCOVERY
template<> constexpr unsigned int TopicTraits<::qi::MotorCmd>::type_map_blob_sz() { return 458; }
template<> constexpr unsigned int TopicTraits<::qi::MotorCmd>::type_info_blob_sz() { return 100; }
template<> inline const uint8_t * TopicTraits<::qi::MotorCmd>::type_map_blob() {
 ...
 0x01,  0x00,  0x00,  0x00,  0x03,  0x07,  0x9c,  0x3b,  0x62,  0x94,  0x00,  0x00,  0xf2,  0x00,  0x00,  0x00, 
 0x01,  0x00,  0x00,  0x00,  0xf2,  0xeb,  0x63,  0x8a,  0xa4,  0x4e,  0x5c,  0x96,  0x16,  0x01,  0xdd,  0xc3, 
 0x38,  0x87,  0x6b,  0x00,  0xda,  0x00,  0x00,  0x00,  0xf2,  0x51,  0x01,  0x00,  0x15,  0x00,  0x00,  0x00, 
 0x00,  0x00,  0x00,  0x00,  0x0d,  0x00,  0x00,  0x00,  0x71,  0x69,  0x3a,  0x3a,  0x4d,  0x6f,  0x74,  0x6f, 
 0x72,  0x43,  0x6d,  0x64,  0x00,  0x00,  0x00,  0x00,  0xb6,  0x00,  0x00,  0x00,  0x07,  0x00,  0x00,  0x00, 
 ...
 0x00,  0x00,  0x00,  0x00,  0x22,  0x00,  0x00,  0x00,  0x01,  0x00,  0x00,  0x00,  0xf2,  0xeb,  0x63,  0x8a, 
 0xa4,  0x4e,  0x5c,  0x96,  0x16,  0x01,  0xdd,  0xc3,  0x38,  0x87,  0x6b,  0xf1,  0xc8,  0xe5,  0x83,  0x5b, 
 0x0f,  0x0c,  0x17,  0x65,  0xbc,  0x23,  0x1d,  0xfa,  0x02,  0xff, };
  return blob;
}
template<> inline const uint8_t * TopicTraits<::qi::MotorCmd>::type_info_blob() {
  static const uint8_t blob[] = {
 ...
 0x14,  0x00,  0x00,  0x00,  0xf2,  0xeb,  0x63,  0x8a,  0xa4,  0x4e,  0x5c,  0x96,  0x16,  0x01,  0xdd,  0xc3, 
 0x38,  0x87,  0x6b,  0x00,  0xde,  0x00,  0x00,  0x00,  0x00,  0x00,  0x00,  0x00,  0x04,  0x00,  0x00,  0x00, 
 0x00,  0x00,  0x00,  0x00, };
  return blob;
}
...
template <>
struct topic_type_name<::qi::MotorCmd>
{
    static std::string value()
    {
      return org::eclipse::cyclonedds::topic::TopicTraits<::qi::MotorCmd>::getTypeName();
    }
};
...
REGISTER_TOPIC_TYPE(::qi::MotorCmd)
...
template<>
propvec &get_type_props<::qi::MotorCmd>();

template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool write(T& streamer, const ::qi::MotorCmd& instance, entity_properties_t *props) {
  (void)instance;
...
bool write(S& str, const ::qi::MotorCmd& instance, bool as_key) {
  auto &props = get_type_props<::qi::MotorCmd>();
  str.set_mode(cdr_stream::stream_mode::write, as_key);
  return write(str, instance, props.data()); 
}

template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool read(T& streamer, ::qi::MotorCmd& instance, entity_properties_t *props) {
  (void)instance;
  if (!streamer.start_struct(*props))
    return false;
  auto prop = streamer.first_entity(props);
...
template<typename S, std::enable_if_t<std::is_base_of<cdr_stream, S>::value, bool> = true >
bool read(S& str, ::qi::MotorCmd& instance, bool as_key) {
  auto &props = get_type_props<::qi::MotorCmd>();
...
template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool move(T& streamer, const ::qi::MotorCmd& instance, entity_properties_t *props) {
  (void)instance;
  if (!streamer.start_struct(*props))
    return false;
  auto prop = streamer.first_entity(props);
...
template<typename S, std::enable_if_t<std::is_base_of<cdr_stream, S>::value, bool> = true >
bool move(S& str, const ::qi::MotorCmd& instance, bool as_key) {
  auto &props = get_type_props<::qi::MotorCmd>();
...
template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool max(T& streamer, const ::qi::MotorCmd& instance, entity_properties_t *props) {
  (void)instance;
  if (!streamer.start_struct(*props))
    return false;
  auto prop = streamer.first_entity(props);
...
template<typename S, std::enable_if_t<std::is_base_of<cdr_stream, S>::value, bool> = true >
bool max(S& str, const ::qi::MotorCmd& instance, bool as_key) {
  auto &props = get_type_props<::qi::MotorCmd>();
